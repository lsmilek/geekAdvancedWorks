...
import com.work.lsmilek.BodyHttpResponseFilter;
import com.work.lsmilek.HttpClientHelper;
...
public class HttpOutboundHandler {
    ...
    BodyHttpResponseFilter responseFilter = new BodyHttpResponseFilter();
    ...
    public void handle(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx, HttpRequestFilter filter) {
        ...
        try {
            ...
            map.put("sign",fullRequest.headers().get("sign"));
            String body = httpClientHelper.postAsJSON(url,"",map);
            body = responseFilter.filter(body);
